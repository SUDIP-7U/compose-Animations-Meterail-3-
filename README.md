...
এই প্রজেক্টটি **Jetpack Compose** দিয়ে বানানো, যেখানে **Material 3** ডিজাইন সিস্টেম, **Compose Animation** এবং **Material Icons Extended** ব্যবহার করা হয়েছে।
...
`app/build.gradle.kts` (অথবা `build.gradle`) ফাইলে নিচের dependency গুলো যোগ করুন:
